...
import { decProductCount, incProductCount, removeProduct } from "../redux/actions/cartActions";
          ...
          <div className="col-md-9">
            ...
            <table className="table">
              ...
              {productsInCart.map((product, index) => (
                                        <tr key={product._id}>
                                            <td width="80px">
                                                <ShowImage item={product} url="products/photo" className="card-img-top"></ShowImage>
                                            </td>
                                            <td>
                                                <h5>{product.name}</h5>
